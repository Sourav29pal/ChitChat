        ...
        <div className="min-h-screen w-full flex items-center justify-center py-8 px-4 sm:px-6 bg-slate-950 text-slate-100 relative overflow-y-auto">
            ...
            >
                ...
                <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-indigo-400 font-medium tracking-wide">Real-time messaging, made simple.</p>
                    <p className="text-xs text-slate-400">Sign in to access your messages, groups & calls</p>
                </div>
                ...
                <div className="space-y-1">
                    ...
                    {errors.email && <span className="text-rose-400 text-xs pl-1">Email is required</span>}
                </div>
